    ...
    <ul class="list-reset mt-4">
      <li class="py-4" v-for="artist in artists" :key="artist.id" :artist="artist">
        ...
        <div class="flex items-center justify-between flex-wrap">
          ...
          <button class="bg-tranparent text-sm hover:bg-blue-700 hover:text-white text-blue-500 border border-blue-500 no-underline font-bold py-2 px-4 mr-2 rounded"
          @click.prevent="editArtist(artist)">Edit</button>

          <button class="bg-transprent text-sm hover:bg-red-700 text-red-500 hover:text-white no-underline font-bold py-2 px-4 rounded border border-red-500"
