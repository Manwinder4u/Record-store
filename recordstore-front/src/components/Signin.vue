    ...
    <div class="border p-10 border-grey-light shadow rounded">
      ...
      <form @submit.prevent="signin">
        ...
        <div class="mb-6">
          ...
          <input type="email" v-model="email" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="email" placeholder="Manwinder@maropost.com">
        </div>
        <div class="mb-6">
